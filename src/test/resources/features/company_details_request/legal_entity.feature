...
Feature: This feature demonstrates the various company types that can be searched for by the ECP
  ...
  Legal form codes;
  LF_UK_001 - Private Limited by Shares/(Section 30 Exemption) - private-limited-shares-section-30-exemption
  LF_UK_002 - European Economic Interest Grouping (EEIG) - eeig
  LF_UK_003 - European Public Limited-Liability Company (SE) - european-public-limited-liability-company-se
  LF_UK_004 - Private Limited - ltd
  LF_UK_005 - Public Limited Company - plc
  LF_UK_006 - Unregistered Company - unregistered-company
  LF_UK_007 - Private Limited by Guarantee/no share capital - private-limited-guarant-nsc
  LF_UK_008 - Private Limited by Guarantee/no share capital(use of Limited exemption) - private-limited-guarant-nsc-limited-exemption
  LF_UK_009 - Overseas Company - oversea-company
